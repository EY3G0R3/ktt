"""Interactive parent selection for the native tab tree."""
...
def parent_candidates(
    ...
    for candidate in records:
        if candidate.id == child_tab_id or not candidate.window_ids:
            continue
...
def choose_parent_tab(
    ...
    """Choose a valid parent with rofi, returning None when cancelled."""
    child = next(
